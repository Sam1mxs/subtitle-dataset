...
SAMPLES_SCHEMA = pa.schema(
    [
        ...
        pa.field("style_rotation_degrees", pa.float64()),
        pa.field("style_background_bar", pa.bool_()),
        pa.field("effective_opacity", pa.float64()),
        pa.field("polygon", pa.list_(pa.list_(pa.float64()))),
...
EVENTS_SCHEMA = pa.schema(
    [
        ...
        pa.field("fade_in_ms", pa.int64()),
        pa.field("fade_out_ms", pa.int64()),
        pa.field("style_font_ids", pa.list_(pa.string())),
        pa.field("style_font_size_h_ratio", pa.float64()),
        pa.field("style_align", pa.string()),
        pa.field("language", pa.string()),
...
def sample_record_to_row(record: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "style_rotation_degrees": style.get("rotation_degrees"),
        "style_background_bar": style.get("background_bar") is not None,
        "effective_opacity": record.get("effective_opacity"),
        "polygon": [[float(v) for v in point] for point in (record.get("polygon") or [])],
